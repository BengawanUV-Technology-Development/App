...
TELEMETRY_STALE_AFTER_SECONDS = float(
    os.getenv("TELEMETRY_STALE_AFTER_SECONDS", "3")
)
TELEMETRY_DISCONNECTED_AFTER_SECONDS = float(
    os.getenv("TELEMETRY_DISCONNECTED_AFTER_SECONDS", "10")
)
TELEMETRY_LOG_INTERVAL_SECONDS = float(os.getenv("TELEMETRY_LOG_INTERVAL_SECONDS", "1"))
TELEMETRY_RAW_DEBUG_ENABLED = os.getenv(
    "TELEMETRY_RAW_DEBUG_ENABLED", "false"
).lower() == "true"

MISSION_LOG_SCHEMA_VERSION = int(os.getenv("MISSION_LOG_SCHEMA_VERSION", "1"))
...
JETSON_GCS_HOST = os.getenv("JETSON_GCS_HOST", "").strip()
